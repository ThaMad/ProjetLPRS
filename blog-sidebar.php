...
<header>
	...
	<nav class="navbar navbar-expand-lg navigation" id="navbar">
		<div class="container">
<<<<<<< HEAD:view/formation/lycee.php
		 	 <a class="navbar-brand" href="../../index.php">
			  	<img src="../../images/logo.png" alt="" class="img-fluid">
=======
		 	 <a class="navbar-brand" href="index.php">
			  	<img src="images/logo.png" alt="" class="img-fluid">
>>>>>>> 605900c8fbbfc55b8258d9e7ab19b43e09d41d69:blog-sidebar.php
			  </a>
...
>>>>>>> 605900c8fbbfc55b8258d9e7ab19b43e09d41d69:blog-sidebar.php
			   ...
			   <li class="nav-item dropdown">
<<<<<<< HEAD:view/formation/lycee.php
					<a class="nav-link dropdown-toggle" href="lycee.php" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog <i class="icofont-thin-down"></i></a>
					<ul class="dropdown-menu" aria-labelledby="dropdown05">
						<li><a class="dropdown-item" href="lycee.php">Blog with Sidebar</a></li>

						<li><a class="dropdown-item" href="bts.php">Blog Single</a></li>
					</ul>
			  	</li>
...
<<<<<<< HEAD:view/formation/lycee.php
				<h2 class="mt-3 mb-3"><a href="bts.php">Choose quality service over cheap service  all type of things</a></h2>
				...
				<a href="bts.php" target="_blank" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
=======
...
<<<<<<< HEAD:view/formation/lycee.php
				<h2 class="mt-3 mb-3"><a href="bts.php">All test cost 25% in always in our laboratory</a></h2>
...
<<<<<<< HEAD:view/formation/lycee.php
				<h2 class="mt-3 mb-3"><a href="bts.php">Get Free consulation from our special surgeon and doctors</a></h2>
